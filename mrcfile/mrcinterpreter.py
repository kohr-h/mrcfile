...
from . import utils
from .dtypes import (
    HEADER_DTYPE, FEI_EXTENDED_HEADER_DTYPE, FEI_LEGACY_EXTENDED_HEADER_DTYPE)
    ...
    * :meth:`_read_bytearray_from_stream`
    ...
    def _read_extended_header(self):
        ...
        try:
            ...
            elif self.header.exttyp == b'LFEI':
                self._extended_header.dtype = FEI_LEGACY_EXTENDED_HEADER_DTYPE
        except ValueError:
